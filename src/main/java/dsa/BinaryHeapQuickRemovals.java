...
//    }
//
//    private void swqp(int i, int j){
//        T datai = heap.get(i);
//        T dataj = heap.get(j);
//        heap.set(i,dataj);
//        heap.set(j,datai);
//        mapSwap(datai,dataj,i,j);
//    }
//
//    private void mapSwap(T datai,T dataj,int i, int j){
//        map.get(datai).remove(i);
//        map.get(datai).add(j);
//        map.get(dataj).remove(i);
//        map.get(dataj).add(i);
//    }
//
//    private boolean lee(int k, int parent){
//        if(heap.get(k).compareTo(heap.get(parent))>0) return false;
//        return true;
//    }
//
